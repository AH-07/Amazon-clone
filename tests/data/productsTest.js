...
describe("Test suite: Classes", () => {
  ...
  describe("test suite: Clothing", () => {
    ...
    it("has correct size-chart link", () => {
  ...
  describe("test suite: Appliance", () => {
    ...
    it("has correct links for instructions and warranty", () => {
    ...
    it("returns the warranty and instructions", () => {
